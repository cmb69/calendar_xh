<?php
	...
	$plugin_tx['calendar']['cf_show_event_time']="Whether to display beginning and ending time.";
	$plugin_tx['calendar']['cf_show_event_location']="Whether to display the location.";
	$plugin_tx['calendar']['cf_show_event_link']="Whether to display links.";
